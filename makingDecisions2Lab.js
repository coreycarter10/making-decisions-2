...
/*
  Determine if the letter grade of the given variable 'score'. If the variable is a 90 or above, console log an 'A', between 80 and 89, console log a 'B', between 70 and 79, 
...
if (myFavoriteNumbers.length < 7) {
  ...
  console.log('There are not seven elements in this array!');
}
